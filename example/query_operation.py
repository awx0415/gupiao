...
# 营运能力
operation_list = []
rs_operation = bs.query_operation_data(code="sh.600600", year=2021, quarter=2)
while (rs_operation.error_code == '0') & rs_operation.next():
    operation_list.append(rs_operation.get_row_data())
rs_operation = pd.DataFrame(operation_list, columns=rs_operation.fields)
# 打印输出
print(rs_operation.columns)
print(rs_operation)
# 结果集输出到csv文件
